      ...
      <div class="row g-sm-5 g-3">
        <div class="col-xxl-9">
                        ...
                        <div class="product-detail">
                          <ul>
                            ...
                            <li class="text-content">
                              <span class="text-title">Sold By:</span> Fresho
                            </li>
                  ...
                  <tr class="product-box-contain">
                    <td class="product-detail">
                      <div class="product border-0">
                        ...
                        >
                          <img
                            src="/images/vegetable/product/3.png"
                            class="img-fluid blur-up lazyload"
                            alt=""
                          />
                        </a>
          ...
          <div class="cart-table mt-3">
            ...
            <h6 class="text-content mt-3">
              <span class="text-title">Address : </span>8424 James Lane South San Francisco, CA 94080
            </h6>
            <h6 class="text-content mt-3">
              <span class="text-title">Pin Code :</span> +380
            </h6>
            <h6 class="text-content mt-3">
              <span class="text-title">Phone :</span> +380 (0564) 53 - 29 - 68
            </h6>
          </div>
        </div>
              ...
              <ul>
                ...
                <li>
                  <button
                    ...
                    onclick="location.href = '/order-history';"
                  >
                    <i class="fa-solid fa-arrow-left-long"></i> Return Order History
                  </button>
                </li>
              </ul>
            </div>
